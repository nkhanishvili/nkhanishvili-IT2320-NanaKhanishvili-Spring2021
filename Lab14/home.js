$(function(){
    ...
    $("#button2").on("click", function(){          
     ...
     $("#button3").on("click", function(){      
      ...
      var brewery_URL = baseUrl + searchTerm;
      console.log(brewery_URL);
    ...
    $("#button4").on("click", function(){
      var searchTerm = $("#breweryId").val();//query string #1
      var baseUrl = "https://api.openbrewerydb.org/breweries/";  
      var GET_ID_URL = baseUrl + searchTerm;
      ...
      $.ajax(
        {
          ...
          success: function(data)
          {
            ...
            $("#results").text("");
            var para = $("<p></p>");
            para.text(data.name +" "+ data.id  +" "+ data.city);
            $("#results").append(para);
